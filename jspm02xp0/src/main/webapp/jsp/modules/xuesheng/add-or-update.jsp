...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学校</label>
										<input id="xuexiao" name="xuexiao" class="form-control" placeholder="学校">
									</div>
									<div class="form-group col-md-6">
										<label>学院</label>
									...
									<div class="form-group col-md-6">
										<label>就业导师</label>
										<input id="jiuyedaoshi" name="jiuyedaoshi" class="form-control" placeholder="就业导师">
									</div>
									<div class="form-group col-md-6">
										<label>照片</label>
									...
									<div class="form-group col-md-6">
										<label>出生日期</label>
										<input id="chushengriqi" name="chushengriqi" class="form-control" placeholder="出生日期">
									</div>
									<div class="form-group col-md-6">
										<label>学历</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#jiuyedaoshi").val(ruleForm.jiuyedaoshi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xuexiao != null && res.data.xuexiao != ''){

					$("#xuexiao").val(res.data.xuexiao);
					}
					...
					if(res.data != null && res.data != '' && res.data.jiuyedaoshi != null && res.data.jiuyedaoshi != ''){

					$("#jiuyedaoshi").val(res.data.jiuyedaoshi);
					}
